"""
Refactored BioAnalyzer API with modular endpoint structure.

This is the main FastAPI application that uses modular routers
...
app.include_router(beta_router, prefix="/beta", tags=["Beta Features"])
